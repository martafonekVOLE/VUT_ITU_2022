        ...
        echo ("
            ...
            <div class='col-sm-12'>
                <form method='post' action='editJson.php'>
                    ...
                    // {   
                    //     echo "<div class='mb-3' id='auto-fill-content$index'>";
                    ...
                    // }
                    // echo "<script>
                    // window.localStorage.setItem('currNumber2', $index);
                    // </script>";
                    // echo "<br><label>Ingredience</label><div class='mb-3' id='auto-fill-content$index'> </div>";
                    foreach ($ingredients as $i)
                    {
                        echo "<div class='mb-3' id='auto-fill-content$index'>";
                    ...
                    echo "<br><div class='mb-3' id='auto-fill-content$index'> </div>";
                    ...
                    echo "<label>Postup</label>";
                    foreach ($instructions as $i)
                    {
                        echo "<div class='mb-3' id='auto-fill-desc$index'>";
                    ...
                    echo "<script>
                    window.localStorage.setItem('currDesc2', $index);
                    </script>";
                    echo "<br><div class='mb-3' id='auto-fill-desc$index'> </div>";
